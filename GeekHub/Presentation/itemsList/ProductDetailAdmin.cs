...
{
    public partial class ProductDetailAdmin : UserControl
    {
        public ProductDetailAdmin(string nameProduct, string categoryProduct, string priceProduct, string imageLocation)
        {
            InitializeComponent();
